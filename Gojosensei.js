...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Mr SHANZ`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/gojo.jpg`),"sourceUrl": "https://youtube.com/channel/UCX9GuKbYYWJ80O3Kymkn3Uw"}}}, { quoted: m})
        }
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) return replay(`${mess.owner}`)
                if (!text) return replay(`Where Is The Text?\n\nExample : ${prefix + command} SHANz Handsome`)
...
🔗 *Media Url* : ${images}`,
	    ...
	    case 'yt': case 'song': case 'play': case 'video':{
                if (!text) return reply(`Example : ${prefix + command} Rap god`)
                let yts = require("yt-search")
                let search = await yts(text)
...
┗━━━━━━━━━❊`,
	    ...
	    case 'ytmp3': case 'getmusic': case 'ytaudio': {
                ...
                if (!text) return reply(`Example : ${prefix + command} https://youtu.be/l9RXcCOQvcs 128kbps`)
            ...
            case 'ytmp4': case 'getvideo': case 'ytvideo': {
                ...
                if (!text) return reply(`Example : ${prefix + command} https://youtu.be/l9RXcCOQvcs 360p`)
...
break
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            break
	    case 'botgroup': case 'link': {
                if (!Number(text)) return reply(`么° 🄼-MUSIC BOT  🎧 ❤️\n\n❶ ```Invitation link:✈️ ```\nhttps://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe\n\n➋```Invitation link:✈️ ```\nhttps://chat.whatsapp.com/DHzjhDeAvh826Qm7AzbTbd\n\n❸ ```Invitation link:✈️ ```\nhttps://chat.whatsapp.com/DtUxi2kNRFgDwKySvSlIyo\n\n➍ ```Invitation link:✈️ ```\nhttps://chat.whatsapp.com/E1Om4pyjfATJp44lDxpUEt\n\n么° CHAT GROUP ❤️\nhttps://chat.whatsapp.com/DtyywUf3CB52b11R7UWrcb\n\nTelegram Bot\nhttps://t.me/M_MUSICBOT_1\n`)
...
┃Group Link: https://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe
┃⌛Runtime : ${runtime(process.uptime())}
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/5f6fe2d541176e90b188a.jpg' }, caption: `*Hi Bro ${m.pushName}*\nSubscribe my channel - https://youtube.com/channel/UCX9GuKbYYWJ80O3Kymkn3Uw\n\nJoin our group -\nhttps://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`Group : https://chat.whatsapp.com/IdiOlEAsYiNFZ8Y4lXMYqe\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
case 'allmenu': {
  	anu = `
...
And Again Me (Mr SHANZ 🎉) 🐦 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "YouTube 🦄","url": `${myweb}`}},{"urlButton": {"displayText": "Script 🥀","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
